...
def import_watch_history_json(json_path, db_engine):
    ...
    input_path_json = os.path.join(current_directory, json_path)
    ...
    with open(input_path_json, 'r', encoding='utf-8') as file:
        ...
        with Session(db_engine) as session:
            ...
            # output data written
            print(f"Videos: {session.query(Video).count()} (Deleted: {count_deleted_videos})")
